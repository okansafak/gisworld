...
station_names = [feature["properties"]["ISTASYON"] for feature in station_data["features"]]

# Allow user to select station names
selected_stations = st.multiselect("Select Stations", station_names, station_names)

# Filter station data based on selected stations
